    ...
    <Sheet>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            The purpose of this site is to provide a seamless experience for
            ...
            <a
              target="_blank"
              href="https://github.com/Lsimelus"
              className="text-sky-600"
            >
              GitHub profile
            </a>{" "}
            ...
            <a
              target="_blank"
              href="https://portfolio-orcin-theta-51.vercel.app/"
              className="text-sky-600"
            >
            ...
            <strong>Lsimelus@gmail.com</strong> and my{" "}
            <a
              target="_blank"
              href="https://www.linkedin.com/in/lyndbergh-simelus/"
              className="text-sky-600"
            >
              LinkedIn profile.
            </a>
